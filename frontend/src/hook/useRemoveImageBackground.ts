...
//   };
//   const serverResponse: AxiosResponse<ArrayBuffer> = await axios.post(serverEndpoint, { image: base64Data }, options);
//   const base64Result = Buffer.from(serverResponse.data).toString("base64");
